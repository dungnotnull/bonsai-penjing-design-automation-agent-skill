"""
run_test_scenarios.py â€” Skill 170: bonsai-penjing-design-automation
...
SKILLS = ROOT / "skills"
GATES = ["U1","U2","U3","U4","U5","U6"] + [g["id"] for g in [{"id": "G1", "check": "Target school & classical form identified and matched to source material", "fix": "Re-match form to material"}, {"id": "G2", "check": "Pruning plan grounded in pruning physiology (apical dominance/auxin, timing, healing)", "fix": "Re-derive pruning from physiology"}, {"id": "G3", "check": "Rock/landscape composition specified for penjing/ishitsuki designs", "fix": "Add rock/landscape composition"}, {"id": "G4", "check": "Species care plan (watering/soil/repotting) is species-specific", "fix": "Add species-specific care"}]]
VERDICTS = ["Award-Level Design", "Solid Design (refinements)", "Needs Significant Rework", "Inconclusive"]
