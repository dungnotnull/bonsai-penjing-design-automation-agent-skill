# test-scenarios.md — Skill 170: bonsai-penjing-design-automation
...
- **Input:** a typical Bonsai/Penjing Art & Botanical Pruning Design case with complete inputs.
...
- **Verdict target:** Award-Level Design.
...
### Verdict coverage
Award-Level Design, Solid Design (refinements), Needs Significant Rework, Inconclusive.
